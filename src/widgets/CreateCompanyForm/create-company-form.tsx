      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Введите основную информацию о компании</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Создайте и управляйте дашбордами для этой компании</CardDescription>
            </div>
